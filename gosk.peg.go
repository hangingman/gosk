...
func (p *Parser) Init() {
	...
	_rules = [...]func() bool{
		...
		/* 3 token <- <((label_line Action4) / (nimonic_line Action5) / (<(!'\n' .)*> Action6))> */
		func() bool {
		...
		func() bool {
			...
			l36:
				...
				add(rulenimonic_line, position35)
			}
			return true
		l34:
